...
interface DismissibleHintProps {
  ...
  /**
   * Wrapper classes (layout container, vertical spacing). Kept inside the
   * component so dismissing the hint removes its spacing along with it.
   */
  className?: string;
}
...
const DismissibleHint = ({ id, children, className }: DismissibleHintProps) => {
