...
const UnifiedInputPanel = ({ 
  ...
  const { ogData, isLoadingPreview } = useLinkPreview(
    inputItems.find(item => item.type === 'link')?.content?.url || ''
  );
            ...
            <div className={`overflow-hidden transition-all duration-300 ease-in-out ${
              ...
              >
                <Textarea
                  ...
                  className="min-h-[100px] resize-none border-0 bg-transparent focus:ring-0 focus:border-0 text-base"
                />
