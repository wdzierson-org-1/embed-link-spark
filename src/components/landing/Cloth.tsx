// Vendored from Canvas UI (canvasui.dev/docs/components/cloth) by David Haz,
// MIT. Local changes: removed the Next.js "use client" directive (Vite SPA).
//
// NOTE: the fabric effect needs the experimental HTML-in-canvas browser API
// (canvas layoutsubtree + ctx.drawElementImage). supportsHtmlInCanvas() gates
// it; unsupported browsers render the children normally with no effect.
...
export function createCloth(
  ...
  capture = () => {
    ...
    try {
      ...
      /* capture can fail transiently while the subtree lays out */
    }
  };
