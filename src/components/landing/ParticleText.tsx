...
// Vendored from React Bits (reactbits.dev/text-animations/particle-text) by
// David Haz, MIT. Local changes: the wrapper's hardcoded min-height was
// removed so the caller's className controls the canvas box.
