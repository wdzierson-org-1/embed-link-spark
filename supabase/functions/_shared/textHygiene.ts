...
//
// PAIRED FILE: src/utils/textHygiene.ts is the vitest-tested mirror of these
// pure helpers for the web client. Any change here must be made there too
// (and vice versa). See that file for the full rationale.
